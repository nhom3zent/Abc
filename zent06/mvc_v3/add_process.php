<?php
    ...
    include_once("conn.php"); 
        ...
        // chèn thêm vào bảng users 
    $query = "INSERT INTO users(id,name,mobile,password,email,gender,address)VALUES('','$name','$mobile','$password','$email','$gender','$address')"; 
    ...
    //     $mail->Username   = "zentgroup@gmail.com"; // Tên đăng nhập tài khoản Gmail
    ...
    //     send_email($email,$name,"Bạn vừa đăng kí thành công tài khoản: ".$name, "PHP_06");
