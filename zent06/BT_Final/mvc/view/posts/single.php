...
<div class="stunning-header stunning-header-bg-lightviolet">
    <div class="stunning-header-content">
        <h1 class="stunning-header-title"><?php echo $data['title']; ?></h1>
    </div>
</div>
        ...
        <main class="main">
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <div class="post-thumb" style="border: 1px solid red, padding-left: 200px">
                        <img src="<?php echo $data['image']; ?>" alt="seo">
                   </div>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <p class=""><?php echo $data['description']; ?>
                            </p>
                            ...
                            <h4 class="mb30"><?php echo $data['title']; ?></h4>

                            <p class="post__text"><?php echo $data['content']; ?>
                            </p>
