                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="<?php echo $value['image']; ?>" alt="our case">
                                    </div>
                                    <h6 class="case-item__title"><a href="blog.php?act=show&id=<?php echo $value['id']; ?>"><?php echo $value['title']; ?></a></h6>
                                </div>
                            </div>
                            <?php } 
                                $page = isset($_GET['page'])?$_GET['page']:'1';
                                if ($current_page > 1 && $total_page > 1){
                                    echo '<a href="blog.php?page='.($current_page-1).'">Prev</a> | ';
                                }
                                ...
                                if ($current_page < $total_page && $total_page > 1){
                                    echo '<a href="blog.php?page='.($current_page+1).'">Next</a> | ';
                                }
                            ?>
