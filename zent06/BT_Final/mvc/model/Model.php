<?php 
	...
	class Model
	{
		...
		public function find1($name){ // phuong thức lấy dữ liệu theo id
			$query = "SELECT * FROM $this->table where $this->primaryname = "."'".$name."'"; // câu lệnh truy vấn
			$result = $this->conn->query($query); // thực thi
			// die($);
			return $result->fetch_assoc(); // trả lại kết quả mỗi hàng 
		}
		...
		public function thongtin($start,$limit){		
