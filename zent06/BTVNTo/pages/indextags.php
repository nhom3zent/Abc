 ...
 <div class="container-fluid">
    <div class="row">
        <div class="col-lg-8">
            ...
            $result = mysqli_query($conn, 'select count(id) as total from tags');
            ...
            $result = mysqli_query($conn, "SELECT * FROM tags LIMIT $start, $limit");
            // var_dump($result);die;
            ?>
            <div class="khung">
                <h2 align="center">DANH SÁCH BÀI TAGS</h2>
